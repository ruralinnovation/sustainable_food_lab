...
here::i_am("R/viz_bare_ground_breakdown.Rmd")
...
fill_scale <- c(
  "bare_ground_acres" = params$colors$bare_ground,
  "regen_ag_acres" = params$colors$regen_ag
)
...
fig <- dta_a %>%
  tidyr::pivot_wider() %>%
  select(STATE_NAME, bare_ground_acres, regen_ag_acres) %>%
...
save_plot(fig, here::here("export/bare_ground_b.svg"), chart_width = 2, chart_height = 4, add_logo = FALSE)
...
save_plot(fig, here::here("export/bare_ground_c.svg"), chart_width = 2, chart_height = 4, add_logo = FALSE)
...
save_plot(fig, here::here("export/bare_ground_baseline.svg"), chart_width = 2, chart_height = 4, add_logo = FALSE)
