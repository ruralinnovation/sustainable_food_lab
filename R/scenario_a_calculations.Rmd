...
library(cori.utils) # <- import include() function
library(dplyr)
library(ggplot2)
library(yaml)
...
include(here::here("R/utils.R"))
include(here::here("R/get_scenario_a_data.R"))
...
# Pull in Calculations for scenario A
# TODO: Comment here about pre-processing script ...
dta_calc <- get_scenario_a_data()
